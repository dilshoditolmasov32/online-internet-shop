...
function useLazyRef2(init, initArg) {
  const ref = React21.useRef(UNINITIALIZED);
...
function useControllableReducer(parameters) {
  ...
  const controlledPropsRef = React28.useRef(controlledProps);
  if (true) {
    React28.useEffect(() => {
      Object.keys(controlledProps).forEach((key) => {
...
function useList(params) {
  ...
  const actionContext = React30.useMemo(() => _extends2({}, reducerActionContext, listActionContext), [reducerActionContext, listActionContext]);
...
function useTheme(defaultTheme5 = null) {
  const contextTheme = React34.useContext(ThemeContext);
...
function createBox(options = {}) {
  ...
  const Box2 = React36.forwardRef(function Box3(inProps, ref) {
...
var ThemeContext2 = React38.createContext(null);
if (true) {
...
function useTheme3() {
  const theme = React39.useContext(ThemeContext_default);
  if (true) {
...
var RtlContext = React41.createContext();
...
var PropsContext = React42.createContext(void 0);
...
function useCurrentColorScheme(options) {
  ...
  const setMode = React46.useCallback((mode) => {
  ...
  const setColorScheme = React46.useCallback((value) => {
    if (!value) {
      setState((currentState) => {
        try {
  ...
  const handleMediaQuery = React46.useCallback((event) => {
  ...
  const mediaListener = React46.useRef(handleMediaQuery);
...
function createCssVarsProvider(options) {
  ...
  const ColorSchemeContext = React47.createContext(void 0);
  if (true) {
    ColorSchemeContext.displayName = "ColorSchemeContext";
  }
  const useColorScheme2 = () => {
    const value = React47.useContext(ColorSchemeContext);
    if (!value) {
  ...
  function CssVarsProvider2(props) {
    ...
    const ctx = React47.useContext(ColorSchemeContext);
    ...
    const element = (0, import_jsx_runtime13.jsxs)(React47.Fragment, {
      children: [shouldGenerateStyleSheet && (0, import_jsx_runtime13.jsxs)(React47.Fragment, {
...
// node_modules/@mui/joy/node_modules/@babel/runtime/helpers/esm/typeof.js
function _typeof(o) {
...
// node_modules/@mui/joy/node_modules/@babel/runtime/helpers/esm/toPrimitive.js
...
// node_modules/@mui/joy/node_modules/@babel/runtime/helpers/esm/toPropertyKey.js
...
function createGrid(options = {}) {
  ...
  const GridOverflowContext = React49.createContext(void 0);
  if (true) {
  ...
  const Grid2 = React49.forwardRef(function Grid3(inProps, ref) {
    ...
    const overflow2 = React49.useContext(GridOverflowContext);
    const {
      className,
      children,
    ...
    let result = (0, import_jsx_runtime15.jsx)(GridRoot, _extends({
      ...
      children: React49.Children.map(children, (child) => {
        if (React49.isValidElement(child) && isMuiElement(child, ["Grid"])) {
...
var RowListContext = React53.createContext(false);
if (true) {
...
var ClassNameConfiguratorContext = React54.createContext(defaultContextValue);
if (true) {
...
function useClassNamesOverride(generateUtilityClass4) {
  ...
  } = React54.useContext(ClassNameConfiguratorContext);
  return (slot) => {
...
function useRootElementName(parameters) {
  ...
  const [rootElementName, setRootElementName] = React55.useState(rootElementNameProp.toUpperCase());
  if (true) {
    React55.useEffect(() => {
  ...
  const updateRootElementName = React55.useCallback((instance) => {
...
var VariantColorContext = React62.createContext(void 0);
if (true) {
...
function useVariantColor(instanceVariant, instanceColor, alwaysInheritColor = false) {
  const value = React62.useContext(VariantColorContext);
...
function VariantColorProvider({
  ...
  return (0, import_jsx_runtime20.jsx)(VariantColorContext.Provider, {
...
export {
  ...
  globalStateClasses2 as globalStateClasses,
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-2IAIKTHV.js.map
